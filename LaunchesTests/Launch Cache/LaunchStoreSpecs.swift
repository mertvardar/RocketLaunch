...
protocol FailableRetrieveLaunchSpecs: LaunchStoreSpecs {
    func test_retrieve_deliversFailureOnRetrievalError()
    func test_retrieve_deliversFailureTwiceOnRetrievalError()
}

protocol FailableInsertLaunchSpecs: LaunchStoreSpecs {
    func test_insert_deliversErrorOnInsertionError()
    func test_insert_hasNoSideEffectsOnInsertionError()
}

protocol FailableDeleteLaunchSpecs: LaunchStoreSpecs {
